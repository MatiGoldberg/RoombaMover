...
namespace ResetRoomba
{
    class RoombaSerial
    {
        ...
        {
            TRACE("ResetSerialPort", "Wakeup.");
            device_detect.Write(false);
            Thread.Sleep(100);
            device_detect.Write(true);
            Thread.Sleep(2000);

            TRACE("ResetSerialPort", "Resetting.");
            for (int i=0; i<3; i++)
            {
                device_detect.Write(false);
                Thread.Sleep(250);
            ...
            TRACE("ResetSerialPort", "done.");
        }
        
        
        public void StartRommbaCommunication()
        {
    ...
    class RoombaDefines
    {
        public const int BAUDRATE = 19200; //115200;
